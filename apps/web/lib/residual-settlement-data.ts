...
/**
 * Builds the only operational data a rejected or suspended organization may
 * still see: incomplete off-platform driver-payment records for completed,
 * host-confirmed hauls. It deliberately refuses operational organizations,
 * archived organizations, inactive identities, and ambiguous memberships.
 */
export function residualSettlementItemsForOrganization(
  ...
  if (!profile || !organization || memberships.length !== 1) {
    return []
  }
