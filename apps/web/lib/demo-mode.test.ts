...
describe("local demo and development session policy", () => {
  ...
  it("denies CI, Vercel, Clerk, and hosted app URLs even when flags are enabled", () => {
    ...
    expect(decideDevSession({ ...localProduction, CI: "true" }, "127.0.0.1:3002").enabled).toBe(false)
