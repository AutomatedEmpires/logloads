...
export default async function Page() {
  ...
  const grounding = buildAssistantGrounding(context.network, "fleet", context.actor.profile.fullName)
  const initial = assistantInitialData(grounding)

  return <AssistantPage account={shellAccountFor(context)} intro={initial.intro} role="fleet" suggestions={initial.suggestions} />
}
