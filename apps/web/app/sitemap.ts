...
const staticRoutes: Array<{ path: string; priority: number; changeFrequency: "hourly" | "daily" | "weekly" | "monthly" }> = [
  ...
  { changeFrequency: "monthly", path: "/pilot", priority: 0.9 },
  { changeFrequency: "monthly", path: "/pilot/host", priority: 0.8 },
  { changeFrequency: "monthly", path: "/pilot/fleet", priority: 0.8 },
  { changeFrequency: "monthly", path: "/pilot/driver", priority: 0.8 },
