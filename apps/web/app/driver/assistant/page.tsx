...
export default async function Page() {
  ...
  const grounding = buildAssistantGrounding(context.network, "driver", context.actor.profile.fullName)
  const initial = assistantInitialData(grounding)

  return <AssistantPage account={shellAccountFor(context)} intro={initial.intro} role="driver" suggestions={initial.suggestions} />
}
